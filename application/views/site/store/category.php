...
<?php if ($ct['img_path'] == null):?>
<img src="<?php echo img_url($system['img_category_default']) ?>" alt="<?php echo $ct['title_category']?>" class="card-img">
<?php else:?>
	<img src="<?php echo img_url($ct['img_path']) ?>" alt="<?php echo $ct['title_category']?>" class="card-img">
<?php endif;?>
	<div class="card-img-overlay">
		<h2 class="card-title text-white title"><?php echo $ct['title_category']?></h2>
	</div>
</div>
<!-- /Category Banner -->
...
<!-- url_filter -->
<div class="row no-gutters gutters-2 codepage" id="url_fil" data-codepage="<?php echo $code_page?>" data-url="<?php if($filter != null) echo $filter?>"  data-filter='<?php if($data_filter != null) echo $data_filter?>'>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<form action="<?php echo base_url('Category/'.$ct['slug_category'])?>" action="GET">
					...
					<div class="form-group text-center">
						...
						<button type="reset" id="reset" class="btn btn-light" data-url="<?php echo base_url("Category/".$slug);?>">CLEAR ALL</button>

			...
			<div class="card">
				<div class="card-body">
					<div class="col-md-3 offset-md-9 text-right">
						<a href="<?php echo base_url('admin/Page/addHelp')?>" class="btn btn-primary mb-3">+ Tambah Halaman</a>
					</div>
							...
							<tbody>
								<tr role="row" class="odd">
									...
									<td>
										<?php echo $h['judul']?> </td>
										<td>
									<a href="<?php echo base_url('admin/page/del_help/'.$h['id'])?>" class="btn btn-danger btn-sm waves-effect waves-light del_page" role="button" aria-pressed="true">
										<span class="btn-label"><i class="fa as fa-ban"></i></span>Hapus</a>
										<a href="<?php echo base_url('admin/page/edit_help/'.$h['id'])?>" class="btn btn-info btn-sm waves-effect waves-light" role="button" aria-pressed="true">

...
<?php $isEdit = $page_title == "Perbarui Produk"? true: false; ?>
		<div class="row">
			...
			<form enctype="multipart/form-data" id="add_user" method="post" action="<?php echo base_url('admin/user/create_user/')?>" data-dir="" data-url="">
			<div class="col-sm-12 col-md-8">
              ...
              <div class="col-sm-12 col-md-8">
                <div class="form-group">
                  <label for="firstname" class="control-label col-form-label">Gambar<span
                      class="text-danger">*</span></label>
                  <input type="file" class="form-control" name="img_path"  required <?php if($isEdit) echo "value='".$useradminDetail['img_path']."'"?>>
                </div>
              </div>

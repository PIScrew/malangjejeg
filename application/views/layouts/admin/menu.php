	...
	<div class="scroll-sidebar">
		...
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
				...
				<!-- Dashboard Produk -->
				<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url('admin/DashboardProduk')?>"
					 aria-expanded="false"><i class="mdi mdi-apps"></i><span class="hide-menu">Dashboard Produk</span></a></li>
				<!-- End Dashboard Produk -->

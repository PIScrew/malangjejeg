...
class Mod_product extends CI_Model {
  ...
  public function editVariation($id,$data){
    $this->db->set($data);
    $this->db->where('id',$id);
    $this->db->update_batch($this->product_variant);
  }
  public function deleted_variation($id){
    $this->db->where('id_product',$id);
    $this->db->delete($this->product_variant);
  ...
  public function CountVariant($id){
    $this->db->where('id_product',$id);
    $this->db->select('variation as jumlah');
    $this->db->from($this->product_variant);
    $query = $this->db->get();
  ...
  public function deleteImage($id){
    $this->db->where('id',$id);
    $this->db->delete($this->product_img);
  }
